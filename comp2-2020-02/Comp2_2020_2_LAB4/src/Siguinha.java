...
public class Siguinha {
  ...
  private Map<Long, Aluno> alunoByDRE = new HashMap<Long, Aluno>();
  ...
  public static Periodo obterPeriodoCorrente() {
    ...
    if (periodoCorrente != null) {
      if (periodoCorrente.getAno() != obterAnoCorrente() || periodoCorrente.getSemestre() != obterSemestreCorrente()) {
  ...
  public Aluno cadastrarAluno(Aluno aluno) {
    return this.alunoByDRE.putIfAbsent(aluno.getDre(), aluno);
  }
