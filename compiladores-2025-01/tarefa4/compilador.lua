        ...
        elseif expr.tag == "ExpChamada" then
            ...
            if func.tag == "ValLibFunc" then
                if #args ~= func.arity then
                    reportError(string.format("Function '%s' expects %d arguments, but got %d.", expr.expf.value, func.arity, #args))
                end

                return func.call(args)
            elseif func.tag == "ValLuaFunc" then
                if #args ~= #func.params then
                    reportError(string.format("Function '%s' expects %d arguments, but got %d.", expr.expf.value, #func.params, #args))
                end
