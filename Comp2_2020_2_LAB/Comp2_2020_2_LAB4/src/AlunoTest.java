...
public class AlunoTest {
  ...
  public void testarAtualizacaoCraComAprovacoes() {
    ...
    assertEquals("O CRA deve refletir a média ponderada das notas finais já obtidas", 10, fulana.getCra(),
        MAX_FLOAT_DIFF);
  }
  ...
  public void testarAtualizacaoCreditosAcumuladosComAprovacoes() {
    ...
    assertEquals("A quantidade de créditos acumulados deve refletir o somátorio "
        + "dos créditos das disciplinas em que houve aprovação", 4, fulana.getCreditosAcumulados());
  }

  @Test
  public void testarAtualizacaoHistoricoComAprovacoes() {
    fulana.inserirItemHistorico(algGraf, 10, periodo20201);
    String historicoDesejado = "Aluno(a): Fulana de Tal (DRE: 1234)\n" + "2020.1 - Algoritmos e Grafos - 10"
        + decimalSeparator + "0";

    assertEquals("O histórico deve conter todas as disciplinas cursadas", historicoDesejado,
        fulana.getHistoricoParaImpressao());
  }

  @Test
  public void testarAtualizacaoCraComReprovacoes() {
    fulana.inserirItemHistorico(calculo1, 3, periodo20201);
    assertEquals("O CRA deve refletir a média ponderada das notas finais já obtidas", 3, fulana.getCra(),
        MAX_FLOAT_DIFF);
  }
  ...
  public void testarAtualizacaoCreditosAcumuladosComReprovacoes() {
    fulana.inserirItemHistorico(calculo1, 3, periodo20201);
    assertEquals("A quantidade de créditos acumulados deve refletir o somátorio "
        + "dos créditos APENAS das disciplinas em que houve aprovação", 0, fulana.getCreditosAcumulados());
  }

  @Test
  public void testarAtualizacaoHistoricoComReprovacoes() {
    fulana.inserirItemHistorico(calculo1, 3, periodo20201);
    String historicoDesejado = "Aluno(a): Fulana de Tal (DRE: 1234)\n" + "2020.1 - Calculo 1 - 3" + decimalSeparator
        + "0";
  ...
  public void testarDisciplinasRepetidasNoMesmoPeriodo() {
    ...
    String historicoDesejado = "Aluno(a): Fulana de Tal (DRE: 1234)\n" + "2020.1 - Calculo 1 - 8" + decimalSeparator
        + "5";
